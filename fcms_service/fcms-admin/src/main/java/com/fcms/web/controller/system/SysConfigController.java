...
public class SysConfigController extends BaseController
{
     ...
     * 根据参数键名查询参数值
     */
    @GetMapping(value = "/configKeyValues/{configKey}")
    public AjaxResult getConfigKeyValues(@PathVariable String configKey)
    {
        return AjaxResult.success(configService.selectConfigKeyValues(configKey));
    }
